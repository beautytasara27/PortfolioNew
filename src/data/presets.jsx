export const initialState = [
    ...
    },
    {
      projectId: "3",
      Date: "Feb 21, 2022",
      projectName: "Fruit Sorting Model",
      Languages: ["Python"],
    ...
    },
    {
      projectId: "7",
      Date: "July 30, 2020",
      projectName: "Mental Health First",
      Languages: ["Java", "Javascript"],
      Frameworks: ["Java Springboot", "ReactJS"],
      paragraphs: [
        {
          Title: "Overview",
          Description:
      ...
      paragraphs: [
        {
          Title: "Overview",
          Description:
            "I used to love playing Pacman as a child so when I first learned game development, it was only natural to want to replicate it. I developed this game in my first semester of learning programming and I fell in love with it.",
        },
      ],
